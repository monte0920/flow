    ...
    try {
        ...
        if (
          xpos >=
            blocks.filter((a) => a.id == id)[0].x -
              blocks.filter((a) => a.id == id)[0].width / 2 -
              paddingx &&
          xpos <=
            blocks.filter((a) => a.id == id)[0].x +
              blocks.filter((a) => a.id == id)[0].width / 2 +
          ...
          ypos <=
            blocks.filter((a) => a.id == id)[0].y +
              blocks.filter((a) => a.id == id)[0].height
        ) {
          return true;
        } else {
          return false;
      ...
      flowy.moveBlock = function (event) {
        ...
        if (active || rearrange) {
          if (
            mouse_x >
              canvas_div.getBoundingClientRect().width +
                canvas_div.getBoundingClientRect().left -
                10 &&
            mouse_x <
              canvas_div.getBoundingClientRect().width +
            ...
            mouse_y >
              canvas_div.getBoundingClientRect().height +
                canvas_div.getBoundingClientRect().top -
                10 &&
            mouse_y <
              canvas_div.getBoundingClientRect().height +
          ...
          for (var w = 0; w < blocks.length; w++) {
            ...
            if (blocks.filter((a) => a.id == blocko[w])[0].parent != -1) {
              ...
              var arrowx =
                ...
                blocks.filter(
                  (a) =>
                    a.id == blocks.filter((a) => a.id == blocko[w])[0].parent
                )[0].x;
              if (arrowx < 0) {
                document.querySelector(
